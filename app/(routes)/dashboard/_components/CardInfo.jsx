...
//                 <h2 className="text-md ">ALAEXPENSE SMART AI</h2>
//                 <Sparkles
...
import formatNumber from "@/utils/formatNumber"; // Ensure correct import path
import getFinancialAdvice from "@/utils/getFinancialAdvice";
    ...
    if (totalBudget > 0 || totalIncome > 0 || totalSpend > 0) {
      const fetchFinancialAdvice = async () => {
        try {
          ...
          setFinancialAdvice("Error fetching financial advice");
        }
      };
